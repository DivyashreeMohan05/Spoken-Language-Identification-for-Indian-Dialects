...
## Approach
-Fine-tuning **mms-300m** to classify short audio segments across **22 official Indian languages** (Assamese, Bengali, Hindi, Tamil, Telugu, Urdu, and more) — as part of a university ML project.
